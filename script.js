...
function gameOver(a) {
    var gameOverAlertElement = "<b>GAME OVER </b><br><br> Player " + span[a].dataset.player.toUpperCase() + ' whooped your butt! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>ITS A DRAW!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
